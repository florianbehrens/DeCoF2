...
void xml_visitor::visit(observable_parameter<boolean> *param)
{
    write_param(param, "BOOLEAN");
}

void xml_visitor::visit(observable_parameter<integer> *param)
{
    write_param(param, "INTEGER");
}

void xml_visitor::visit(observable_parameter<real> *param)
{
    write_param(param, "REAL");
}

void xml_visitor::visit(observable_parameter<string> *param)
{
    write_param(param, "STRING");
}

void xml_visitor::visit(observable_parameter<binary> *param)
{
    write_param(param, "BINARY");
}

void xml_visitor::visit(observable_parameter<boolean_seq> *param)
{
    write_param(param, "BOOLEAN_SEQ");
}

void xml_visitor::visit(observable_parameter<integer_seq> *param)
{
    write_param(param, "INTEGER_SEQ");
}

void xml_visitor::visit(observable_parameter<real_seq> *param)
{
    write_param(param, "REAL_SEQ");
}

void xml_visitor::visit(observable_parameter<string_seq> *param)
{
    write_param(param, "STRING_SEQ");
}

void xml_visitor::visit(observable_parameter<binary_seq> *param)
{
